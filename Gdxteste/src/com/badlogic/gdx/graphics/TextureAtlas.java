...
import com.badlogic.gdx.graphics.TextureAtlas.TextureAtlasData.Page;
import com.badlogic.gdx.graphics.TextureAtlas.TextureAtlasData.Region;
...
public class TextureAtlas 
 {
				...
				while (true) {
					...
					if (line.trim().length() == 0)
						...
						if (direction.equals("x"))
							repeatX = TextureWrap.Wrap;
						else if (direction.equals("y"))
							repeatY = TextureWrap.Wrap;
						else if (direction.equals("xy")) {
							repeatX = TextureWrap.Wrap;
							repeatY = TextureWrap.Wrap;
						}

						pageImage = new Page(file,false, format, min, max, repeatX, repeatY);
						pages.add(pageImage);
					} else {
	...
	{
		this(Gdx.files.getFileHandle(internalPackFile,FileType.Internal));
	}
	...
	private void load (TextureAtlasData data) {
		...
		for (Page page : data.pages) {
			...
			if (page.texture == null) {
				texture =  Gdx.graphics.newTexture(page.textureFile,page.minFilter, page.magFilter,page.uWrap, page.vWrap,false);//Texture(page.textureFile, page.format, page.useMipMaps);
