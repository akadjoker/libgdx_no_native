...
public class PolygonRegion {
	...
	public PolygonRegion (TextureRegion region, String file) {
		this.region = region;
	...
	private void loadPolygonDefinition (String file) {
		String line;
		
		InputStream in =Gdx.files.readFile(file, FileType.Internal);
