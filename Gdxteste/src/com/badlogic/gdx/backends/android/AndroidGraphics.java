...
final class AndroidGraphics implements Graphics, Renderer
{
	...
	{	
		return newPixmap( Gdx.files.getFileHandle( file, FileType.Internal ));
	}
	...
	public Texture newTexture(String file, boolean managed)
	{
		...
		{
			if( gl10 != null )
				return new AndroidTexture( this, gl10, (Bitmap)pixmap.getNativePixmap(), TextureFilter.Linear, TextureFilter.Linear, TextureWrap.Wrap, TextureWrap.Wrap, managed );
			else
				return new AndroidTexture( this, gl20, (Bitmap)pixmap.getNativePixmap(),TextureFilter.Linear, TextureFilter.Linear, TextureWrap.Wrap, TextureWrap.Wrap, managed );
	...
	@Override
	public Texture newTexture(FileHandle file, TextureFilter minFilter,TextureFilter magFilter, TextureWrap uWrap, TextureWrap vWrap,boolean managed) {
		
		Pixmap map= newPixmap(file);
		return newTexture(map,minFilter, magFilter, uWrap, vWrap, managed );
