...
public class SpriteSheet extends Image {
	 ...
	 */
	public SpriteSheet(GDXRenderer render,String ref,int tw,int th, int spacing) throws GdxRuntimeException {
		this(render,ref,tw,th,null,spacing);
	}
	 ...
	 * @throws GdxRuntimeException Indicates a failure to load the image
	 */
	public SpriteSheet(GDXRenderer render,String ref,int tw,int th) throws GdxRuntimeException {
		this(render,ref,tw,th,null);
	}
	 ...
	 * @throws GdxRuntimeException Indicates a failure to load the image
	 */
	public SpriteSheet(GDXRenderer render,String ref,int tw,int th, Color col) throws GdxRuntimeException {
		this(render,ref, tw, th, col, 0);
	}
	 ...
	 * @throws GdxRuntimeException Indicates a failure to load the image
	 */
	public SpriteSheet(GDXRenderer render,String ref,int tw,int th, Color col, int spacing) throws GdxRuntimeException {
		super(render,ref, false, FILTER_NEAREST, col);
